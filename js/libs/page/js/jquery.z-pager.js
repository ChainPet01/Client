; (function ($) {
	var methods = {
		...
		pageRender: function (_v, _current) {
			$.fn.zPager.defaults.currentPage = _v.data("options").currentPage;
			$.fn.zPager.defaults.currentPage(_current);
			/**
		...
		pageCurrent: function (_id, _class) {
			 ...
			 * @type {String}
			 */
			return '<div class="' + _class + '" page-id="' + _id + '">' + _id + '</div>';
		},
		elliPsis: function () {
			/**
			 * [class ellipses...]
		...
		pageBtn: function (_id) {
			 ...
			 * @type {String}
			 */
			return '<div><a page-id="' + _id + '">' + _id + '</a></div>';
		},
	...
	$.fn.zPager.defaults = {
		...
		url: '', //ajax路由
		htmlBox: '', //ajax数据写入容器
		currentPage: function name(params) {
			console.log(params)
		}
	}
